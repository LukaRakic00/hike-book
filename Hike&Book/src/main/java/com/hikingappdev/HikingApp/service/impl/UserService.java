...
import com.hikingappdev.HikingApp.repo.UserRepository;
import com.hikingappdev.HikingApp.service.interfac.IUserService;
import com.hikingappdev.HikingApp.utils.JWTUtils;
...
public class UserService implements IUserService {
    ...
    public Response getUserBookingHistory(String userId) {
        ...
        try {
            ...
            UserDTO userDTO = Utils.mapUserEntityToUserDTOPlusUserBookingsAndTours(user);
            response.setStatusCode(200);
            response.setMessage("successful");
            response.setUser(userDTO);
